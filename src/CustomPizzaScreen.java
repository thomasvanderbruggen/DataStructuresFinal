 ...
 * 
 */
public class CustomPizzaScreen extends JFrame {
	 ...
	 */
	public CustomPizzaScreen(Order order, JFrame ogFrame, JTextPane price, TextArea orderToUser) {
